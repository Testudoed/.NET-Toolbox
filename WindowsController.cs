...
namespace Org.Mentalis.Utilities {
	...
	public class WindowsController {
        ...
        //8.5.09 AFD TT#2071 - Added option provided by Exit Windows call to force only if hung.
        private const int EWX_FORCEIFHUNG = 16;
		/// <summary>
		...
		/// <exception cref="PrivilegeException">There was an error while requesting a required privilege.</exception>
		//8.05.09 AFD TT#2071 - Modified to make force option force if hung, instead of just Force.
        protected static void ExitWindows(int how , bool force ) {
			EnableToken("SeShutdownPrivilege");
			if (force )
				how = how | EWX_FORCEIFHUNG;
